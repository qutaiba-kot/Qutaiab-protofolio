...
class ExperinceSkillsWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final sizes = ExperinceResponsive(isMobile: isMobile, isTablet: isTablet, height: height, width: width);
    return HomeAnimation(
      beginOffset: const Offset(-1, 0),
      child: SizedBox(
        height:sizes.skillOuterHeight,
              width:sizes.skillOuterWidth,
        child: Column(
          children: [
            Flexible(
              child: Text(
            ...
            Container(
              ...
              height: sizes.skillInnerHeight,
              width: sizes.skillInnerWidth,
